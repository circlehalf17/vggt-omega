"""
Reconstruct rotation_high_026 with two frame sets:
...
3. all_60/frames_037_060_from_all_60.ply: run VGGT-Omega on all 60 frames,
   then visualize only the point clouds from frames 37..60

Outputs:
  outputs/renders/vggt-omega/ego4d/high026_37_60_compare/<clip_name>/all_60/
  outputs/renders/vggt-omega/ego4d/high026_37_60_compare/<clip_name>/frames_037_060/
    scene.ply
    predictions_pose.npz
    camera_trajectory.png
    metadata.json
  outputs/renders/vggt-omega/ego4d/high026_37_60_compare/<clip_name>/all_60/
    frames_037_060_from_all_60.ply
"""
...
CLIP_NAME = "rotation_high_026__73139ac7-aa0a-4119-bf90-81a94a3f8c55"
DEFAULT_VIDEO = os.path.join(PROJECT_ROOT, "data/ego4d/v2/label/rotation_high", f"{CLIP_NAME}.mp4")
DEFAULT_OUTPUT_DIR = os.path.join(
    PROJECT_ROOT,
    "outputs/renders/vggt-omega/ego4d/high026_37_60_compare",
    CLIP_NAME,
)
DEFAULT_FPS = 6.0
