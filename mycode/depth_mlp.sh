#!/bin/bash
#SBATCH --job-name=vggt_depth_mlp
...
EXPERIMENT_NAME="ego4d_selected_depth_mlp"
...
srun --mpi=pmix singularity exec --nv \
    ...
    bash -c "
        ...
        python infer_selected_depth_mlp.py \
            2>&1 | tee /workspace/outputs/logs/${PROJECT_NAME}/${EXPERIMENT_NAME}/job_${SLURM_JOB_ID}/depth_mlp.log
    "
