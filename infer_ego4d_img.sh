#!/bin/bash
#SBATCH --job-name=vggt_ego4d_img
...
srun --mpi=pmix singularity exec --nv \
    ...
    bash -c "
        ...
        python infer_ego4d_img.py \
            --checkpoint  /workspace/outputs/checkpoints/vggt-omega/vggt_omega_1b_512.pt \
            --data-root   /workspace/data/Ego4D/image \
            --output-dir  /workspace/outputs/renders/vggt-omega/temp \
